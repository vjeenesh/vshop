...
//   doc
//     .fontSize(10)
//     .text("Copyrights VShop 2024", 50, 700, { align: "center", width: 500 });
// }
...
// exports.createInvoice = (order, path) => {
...
//   doc
//     .text(`Invoice Number: ${order._id.toString()}`, 50, 200)
//     .text(`Invoice Date: ${new Date()}`, 50, 215)

//     .text(order.user.username, 300, 200)
//     .text("Shipping street address", 300, 215)
...
//       item.productData.productId.description,
//       item.productData.productPrice,
//       item.quantity,
//       item.productData.productPrice * item.quantity
//     );
//   }
//   doc.end();
//   return doc;
